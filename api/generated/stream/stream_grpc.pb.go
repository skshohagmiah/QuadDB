...
type StreamServiceClient interface {
	...
	SubscribeGroup(ctx context.Context, in *SubscribeGroupRequest, opts ...grpc.CallOption) (StreamService_SubscribeGroupClient, error)
...
func (c *streamServiceClient) SubscribeGroup(ctx context.Context, in *SubscribeGroupRequest, opts ...grpc.CallOption) (StreamService_SubscribeGroupClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[1], StreamService_SubscribeGroup_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &streamServiceSubscribeGroupClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type StreamService_SubscribeGroupClient interface {
	Recv() (*SubscribeResponse, error)
	grpc.ClientStream
}

type streamServiceSubscribeGroupClient struct {
	grpc.ClientStream
}

func (x *streamServiceSubscribeGroupClient) Recv() (*SubscribeResponse, error) {
	m := new(SubscribeResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *streamServiceClient) Read(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (*ReadResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamService_Read_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamServiceClient) ReadFrom(ctx context.Context, in *ReadFromRequest, opts ...grpc.CallOption) (*ReadFromResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamService_ReadFrom_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamServiceClient) Seek(ctx context.Context, in *SeekRequest, opts ...grpc.CallOption) (*SeekResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamService_Seek_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamServiceClient) GetOffset(ctx context.Context, in *GetOffsetRequest, opts ...grpc.CallOption) (*GetOffsetResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamService_GetOffset_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamServiceClient) CommitGroupOffset(ctx context.Context, in *CommitGroupOffsetRequest, opts ...grpc.CallOption) (*CommitGroupOffsetResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamService_CommitGroupOffset_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamServiceClient) GetGroupOffset(ctx context.Context, in *GetGroupOffsetRequest, opts ...grpc.CallOption) (*GetGroupOffsetResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamService_GetGroupOffset_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamServiceClient) CreateTopic(ctx context.Context, in *CreateTopicRequest, opts ...grpc.CallOption) (*CreateTopicResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamService_CreateTopic_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamServiceClient) DeleteTopic(ctx context.Context, in *DeleteTopicRequest, opts ...grpc.CallOption) (*DeleteTopicResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamService_DeleteTopic_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamServiceClient) ListTopics(ctx context.Context, in *ListTopicsRequest, opts ...grpc.CallOption) (*ListTopicsResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamService_ListTopics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamServiceClient) GetTopicInfo(ctx context.Context, in *GetTopicInfoRequest, opts ...grpc.CallOption) (*GetTopicInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamService_GetTopicInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamServiceClient) Purge(ctx context.Context, in *PurgeRequest, opts ...grpc.CallOption) (*PurgeResponse, error) {
	...
	err := c.cc.Invoke(ctx, StreamService_Purge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StreamServiceServer interface {
	...
	SubscribeGroup(*SubscribeGroupRequest, StreamService_SubscribeGroupServer) error
...
func (UnimplementedStreamServiceServer) SubscribeGroup(*SubscribeGroupRequest, StreamService_SubscribeGroupServer) error {
...
func _StreamService_SubscribeGroup_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamServiceServer).SubscribeGroup(m, &streamServiceSubscribeGroupServer{stream})
}

type StreamService_SubscribeGroupServer interface {
	Send(*SubscribeResponse) error
	grpc.ServerStream
}

type streamServiceSubscribeGroupServer struct {
	grpc.ServerStream
}

func (x *streamServiceSubscribeGroupServer) Send(m *SubscribeResponse) error {
	return x.ServerStream.SendMsg(m)
}
